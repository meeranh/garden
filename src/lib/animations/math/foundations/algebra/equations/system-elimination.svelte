...
<div class="container">
	<div class="equations">
		...
		{:else if currentStep === 1}
			<div class="eq-row"><span class="term">x + y</span><span class="eq">=</span><span class="term">10</span></div>
			<div class="eq-row add"><span class="term">x − y</span><span class="eq">=</span><span class="term">2</span><span class="op">+</span></div>
		{:else if currentStep === 2}
			<div class="eq-row result-row"><span class="term">2x</span><span class="eq">=</span><span class="term">12</span></div>
		{:else if currentStep === 3}
			<div class="eq-row"><span class="result">x</span><span class="eq">=</span><span class="result">6</span></div>
		{:else if currentStep === 4}
			<div class="eq-row"><span class="term">6 + y</span><span class="eq">=</span><span class="term">10</span></div>
